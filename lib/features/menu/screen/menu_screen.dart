              ...
              SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _CardBlock(
                      children: [
                        ...
                        _MenuItemRow(
                          ...
                          badgeText: '12',
                          onTap: () =>
                              context.go(NotificationsScreen.routeName),
                          iconSize: 22,
                        ),
                      ],
                    ),
                    ...
                    InkWell(
                      onTap: () => context.push(
                        Zone_Category_Screen.routeWithTitle('Categories'),
                      ),
                    ...
                    _CardBlock(
                      children: [
                        _MenuItemRow(
                          ...
                          iconSize: 22,
                          onTap: () => context.push(
                            Zone_Category_Screen.routeWithTitle('Lighting'),
                          ),
                        ),
                        const _InnerDivider(),
                        _MenuItemRow(
                          ...
                          iconSize: 20,
                          onTap: () => context.push(
                            Zone_Category_Screen.routeWithTitle('Shading'),
                          ),
                        ),
                        const _InnerDivider(),
                        _MenuItemRow(
                          ...
                          iconSize: 20,
                          onTap: () => context.push(
                            Zone_Category_Screen.routeWithTitle(
                              'Heating/Cooling',
                            ),
                          ),
                        ),
                        ...
                        _MenuItemRow(
                          ...
                          iconSize: 23,
                          onTap: () => context.push(
                            Zone_Category_Screen.routeWithTitle('Security'),
                          ),
                        ),
                        const _InnerDivider(),
                        _MenuItemRow(
                          ...
                          iconSize: 24,
                          onTap: () => context.push(
                            Zone_Category_Screen.routeWithTitle('Irrigation'),
                          ),
                        ),
                        const _InnerDivider(),
                        _MenuItemRow(
                    ...
                    InkWell(
                      onTap: () => context.push(
                        Zone_Category_Screen.routeWithTitle('Zones'),
                      ),
                    ...
                    _CardBlock(
                      children: [
                        _MenuItemRow(
                          ...
                          iconSize: 20,
                          onTap: () => context.push(
                            Zone_Category_Screen.routeWithTitle('Whole house'),
                          ),
                        ),
                        const _InnerDivider(),
                        _MenuItemRow(
                          ...
                          iconSize: 22,
                          onTap: () => context.push(
                            Zone_Category_Screen.routeWithTitle('Living room'),
                          ),
                        ),
                        const _InnerDivider(),
                        _MenuItemRow(
                          ...
                          iconSize: 20,
                          onTap: () => context.push(
                            Zone_Category_Screen.routeWithTitle('Kitchen'),
                          ),
                        ),
                        const _InnerDivider(),
                        _MenuItemRow(
                          ...
                          iconSize: 20,
                          onTap: () => context.push(
                            Zone_Category_Screen.routeWithTitle('Bedroom'),
                          ),
                        ),
                        const _InnerDivider(),
                        _MenuItemRow(
                          ...
                          iconSize: 23,
                          onTap: () => context.push(
                            Zone_Category_Screen.routeWithTitle('Kids room'),
                          ),
                        ),
                        const _InnerDivider(),
                        _MenuItemRow(
                          ...
                          iconSize: 24,
                          onTap: () => context.push(
                            Zone_Category_Screen.routeWithTitle('Garden'),
                          ),
                        ),
                        const _InnerDivider(),
                        _MenuItemRow(
...
class _InnerDivider extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      height: 1.h,
      margin: EdgeInsets.only(left: leftInset, right: 17.w),
